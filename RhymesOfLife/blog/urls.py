...
from .views import (
    ...
    hide_article_view, unhide_article_view,
...
urlpatterns = [
    ...
    path('<int:page_id>/hide/', hide_article_view, name='hide_article'),
    path('<int:page_id>/unhide/', unhide_article_view, name='unhide_article'),
